...
I am building an architecture for proving that real images and videos are real (not AI-generated). We do so by attaching metadata, such as time and GPS location, to images and videos. Unlike EXIF, the metadata must be true, uneditable, and [verifiable](https://verify.contentauthenticity.org/). My advisor is Prof. [Andrew Kwong](https://andrewkwong.org).
